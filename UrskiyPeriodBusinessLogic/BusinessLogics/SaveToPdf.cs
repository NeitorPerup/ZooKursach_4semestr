...
namespace UrskiyPeriodBusinessLogic.BusinessLogics
{
    public class SaveToPdf
    {
        public static void CreateDoc(PdfInfo info)
        {
            ...
            List<string> columns = new List<string> { "3cm", "2cm", "5.5cm", "2.5cm", "3cm"};
            ...
            {
                Table = table,
                Texts = new List<string> { "Маршрут", "Кол-во", "Затраты", "Время", "Стоимость" },
                Style = "NormalTitle",
            ...
            foreach (var route in info.Routes)
            {
                ...
                {
                    Table = table,
                    Texts = new List<string> { route.Name, route.Count.ToString(), costs, 
